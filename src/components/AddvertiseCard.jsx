...
{/* <div class="flex justify-center items-center m-0 h-screen"> */}
  
    <card class="grid grid-cols-6 justify-center mx-auto mt-4 max-w-5xl bg-blue-800 rounded-xl">
      
      <div class="col-span-4">
        
        <h2 class="mt-8 ml-10 text-3xl font-bold text-white"> 
          One Stop Solution for Your Entire Online Journey 
        </h2>
        
        <p class="mt-5 ml-10 text-sm font-semibold text-white">
...
— Stephen Hawking
    ...
    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3" />
      ...
      <div class="relative col-span-2">
        <img src="https://www.digitalocean.com/_next/static/media/cloudJourneyImage.954519ea.svg" alt="vectorImage"  class="absolute right-0 bottom-0"/>
      </div>
