...
const SvgComponentMail = (props) => (
  <svg
    width={100}
    height={100}
    className="text-green-600 text-gray-700 transition duration-300 ease-in-out cursor-pointer fill-current dark:text-gray-400 hover:text-red-500 dark:hover:text-red-500"
...
export default SvgComponentMail;
