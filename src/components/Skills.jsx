...
<h1 id="skills" className="text-3xl font-extrabold text-center text-indigo-500 underline underline-offset-4">
        SKILLS
      </h1>
      ...
      <div className="mx-10 lg:ml-32"><a href="#skills"><iframe width="300" height="300"  title="skill" href="#skills" src="https://giphy.com/embed/4xyQcPmh44YiiZEEuZ" frameBorder="0" className="mr-2 ml-2 giphy-embed" allowFullScreen></iframe></a></div>
      
    <div className="grid grid-cols-3 justify-between mt-8 ml-2 lg:mr-24 lg:ml-32 lg:grid-cols-6"> 
