...
const Github = ({ link }) => {
  return (
    <>
      ...
      >
        <svg
          className="text-gray-700 transition duration-300 ease-in-out fill-current dark:text-gray-400 hover:text-black dark:hover:text-black"
          role="img"
          width="24"
          height="24"
          viewBox="0 0 24 24"
...
export { Github, Twitter, LinkedIn, Youtube, Reddit };
